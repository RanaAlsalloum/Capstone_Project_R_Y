...
AR_POS = {
    ...
    "خيالي","أسطوري","مُفرح","سوبر","بديع","يبهج","يعجبني","فنان","قمة"
}
...
EXCLAMATION_BOOST = 0.08   # تعزيز بسيط لو في ! كثيرة
INTENSIFIER_BOOST = 0.10   # تعزيز لو في جداً/مره
RULE_CONF = 0.65           # ثقة افتراضية لو قلبنا بالقاعدة
LOW_CONF = 0.70            # لو أعلى احتمال أقل من هذا نسمح للقاعدة تقلب
NEU_MARGIN = 0.25          # سماحية لفك الحياد
